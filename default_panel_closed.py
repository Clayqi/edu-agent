...
# 加一个切换按钮在右上角
old_topbar = '''<div class="wctl"><button class="wctl-btn" title="停止" onclick="stopGen()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="6" y="6" width="12" height="12" rx="2"/></svg></button></div>'''

new_topbar = '''<div class="wctl"><button class="wctl-btn" title="运行状态" onclick="toggleRightPanel()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M15 4v16"/></svg></button><button class="wctl-btn" title="停止" onclick="stopGen()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="6" y="6" width="12" height="12" rx="2"/></svg></button></div>
